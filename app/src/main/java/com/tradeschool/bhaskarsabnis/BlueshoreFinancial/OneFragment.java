...
public class OneFragment extends Fragment {
    ...
    private String[] scrip = new String[]{"TATATMOTORS", "MARUTI", "ICICIBANK"};
    private double[] ltp = new double[]{180.30,7320.50, 378.55};
    private double[] value = new double[]{0.00, 0.00, 0.00};

    private ArrayList<DataModel_MarketWatch> dataModelArrayList;
    private RecyclerView recyclerView;
    CoordinatorLayout coordinatorLayout;
    DataAdapter_MarketWatch dataAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        dataAdapter = new DataAdapter_MarketWatch(getContext(),dataModelArrayList);
    ...
    private ArrayList<DataModel_MarketWatch> populateList() {
        ArrayList<DataModel_MarketWatch> list = new ArrayList<>();

        for(int i = 0; i < scrip.length; i++){
            DataModel_MarketWatch dataModel = new DataModel_MarketWatch();
